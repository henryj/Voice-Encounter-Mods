...
--BH DELETE	countdownIonization:Start(60-delay)
		...
		sndIonCD:Schedule(56, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\ex_tt_dlzb.mp3")
		sndIonCD:Schedule(57, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\countfour.mp3")
		sndIonCD:Schedule(58, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\countthree.mp3")
		sndIonCD:Schedule(59, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\counttwo.mp3")
		sndIonCD:Schedule(60, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\countone.mp3")
	else
...
--BH DELETE	specWarnStorm:Show()
		...
		timerThrowCD:Start()
		--BH ADD
		sndWOP:Cancel("Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\ex_tt_sdfbzb.mp3")
		...
		if MyJS2() then
			...
			sndWOP:Schedule(5, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\defensive.mp3")
		end		
		sndWOP:Schedule(15, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\ex_tt_fbjs.mp3") --風暴結束
		--BH ADD END		
		if self:IsDifficulty("heroic10", "heroic25") then
...
function mod:SPELL_AURA_APPLIED(args)
	...
	elseif args.spellId == 138732 and args:IsPlayer() then
		...
		inoizame = true
		sndWOP:Play("Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\ex_tt_dlzh.mp3") --電離子化
		if self.Options.SoundWOPIonM then
			...
			sndIon:Schedule(7, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\runout.mp3")
			sndIon:Schedule(8, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\runout.mp3")
		else			
			...
			sndIon:Schedule(16, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\runout.mp3")	--離開人群
			sndIon:Schedule(17, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\runout.mp3")
			sndIon:Schedule(18.5, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\countsix.mp3")
			sndIon:Schedule(19.5, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\countfive.mp3")
			sndIon:Schedule(20.5, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\countfour.mp3")
			sndIon:Schedule(21.5, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\countthree.mp3")
			sndIon:Schedule(22.5, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\counttwo.mp3")
			sndIon:Schedule(23.5, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\countone.mp3")
		end
		--BH MODIFY END
	end
end
...
function mod:SPELL_AURA_REMOVED(args)
	if args.spellId == 138732 and args:IsPlayer() then
		...
		sndIon:Cancel("Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\runout.mp3")
		sndIon:Cancel("Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\countseven.mp3")
		sndIon:Cancel("Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\countsix.mp3")
		sndIon:Cancel("Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\countfive.mp3")
		sndIon:Cancel("Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\countfour.mp3")
		sndIon:Cancel("Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\countthree.mp3")
		sndIon:Cancel("Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\counttwo.mp3")
		sndIon:Cancel("Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\countone.mp3")
		sndIon:Play("Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\safenow.mp3")
...
function mod:CHAT_MSG_RAID_BOSS_EMOTE(msg, _, _, _, target)
	if msg:find("spell:137175") then
		...
		timerStormCD:Start()
		sndWOP:Play("Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\ex_tt_lttz.mp3") --雷霆投擲
		sndWOP:Schedule(55, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\ex_tt_sdfbzb.mp3") -- 閃電風暴準備
		sndWOP:Schedule(56.5, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\countfour.mp3")
		sndWOP:Schedule(57.5, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\countthree.mp3")
		sndWOP:Schedule(58.5, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\counttwo.mp3")
		sndWOP:Schedule(59.5, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\countone.mp3")
...
function mod:RAID_BOSS_WHISPER(msg)
	if msg:find("spell:137422") then--In case target scanning fails, personal warnings still always go off. Target scanning is just so everyone else in raid knows who it's on (since only target sees this emote)
		...
		focusme = true
		VEM.Flash:Shake(1, 0, 0)
		sndWOP:Play("Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\ex_tt_sddn.mp3") --閃電點你
	end
end