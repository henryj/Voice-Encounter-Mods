...
--BH DELETE	countdownIonization:Start(60-delay)
		...
		sndIonCD:Schedule(57, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\countfour.ogg")
		sndIonCD:Schedule(58, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\countthree.ogg")
		sndIonCD:Schedule(59, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\counttwo.ogg")
		sndIonCD:Schedule(60, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\countone.ogg")
	else
...
--BH DELETE	specWarnStorm:Show()
		...
		timerThrowCD:Start()
		--BH ADD
		sndWOP:Cancel("Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\ex_tt_sdfbzb.ogg")
		...
		if MyJS2() then
			...
			sndWOP:Schedule(5, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\defensive.ogg")
		end		
...
function mod:SPELL_AURA_APPLIED(args)
	...
	elseif args.spellId == 138732 and args:IsPlayer() then
		...
		inoizame = true
		sndWOP:Play("Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\ex_tt_dlzh.ogg") --電離子化
		if self.Options.SoundWOPIonM then
			...
			sndIon:Schedule(7, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\runout.ogg")
			sndIon:Schedule(8, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\runout.ogg")
		else			
			...
			sndIon:Schedule(16, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\runout.ogg")	--離開人群
			sndIon:Schedule(17, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\runout.ogg")
			sndIon:Schedule(18.5, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\countsix.ogg")
			sndIon:Schedule(19.5, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\countfive.ogg")
			sndIon:Schedule(20.5, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\countfour.ogg")
			sndIon:Schedule(21.5, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\countthree.ogg")
			sndIon:Schedule(22.5, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\counttwo.ogg")
			sndIon:Schedule(23.5, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\countone.ogg")
		end
		--BH MODIFY END
	end
end
...
function mod:SPELL_AURA_REMOVED(args)
	if args.spellId == 138732 and args:IsPlayer() then
		...
		sndIon:Cancel("Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\runout.ogg")
		sndIon:Cancel("Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\countseven.ogg")
		sndIon:Cancel("Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\countsix.ogg")
		sndIon:Cancel("Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\countfive.ogg")
		sndIon:Cancel("Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\countfour.ogg")
		sndIon:Cancel("Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\countthree.ogg")
		sndIon:Cancel("Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\counttwo.ogg")
		sndIon:Cancel("Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\countone.ogg")
		sndIon:Play("Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\safenow.ogg")
...
function mod:CHAT_MSG_RAID_BOSS_EMOTE(msg, _, _, _, target)
	if msg:find("spell:137175") then
		...
		timerStormCD:Start()
		sndWOP:Play("Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\ex_tt_lttz.ogg") --雷霆投擲
		sndWOP:Schedule(55, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\ex_tt_sdfbzb.ogg") -- 閃電風暴準備
		sndWOP:Schedule(56.5, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\countfour.ogg")
		sndWOP:Schedule(57.5, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\countthree.ogg")
		sndWOP:Schedule(58.5, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\counttwo.ogg")
		sndWOP:Schedule(59.5, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\countone.ogg")
...
function mod:RAID_BOSS_WHISPER(msg)
	if msg:find("spell:137422") then--In case target scanning fails, personal warnings still always go off. Target scanning is just so everyone else in raid knows who it's on (since only target sees this emote)
		...
		focusme = true
		VEM.Flash:Shake(1, 0, 0)
		sndWOP:Play("Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\ex_tt_sddn.ogg") --閃電點你
	end
end