...
function mod:OnCombatStart(delay)
	...
	if self:IsDifficulty("heroic10", "heroic25") then
		...
		if mod.Options.MobA then
			sndWOP:Schedule(88, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\ex_tt_mobA.mp3")
			sndWOP:Schedule(90, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\countfive.mp3")
			sndWOP:Schedule(92, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\countfour.mp3")	
			sndWOP:Schedule(94, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\countthree.mp3")
			sndWOP:Schedule(96, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\counttwo.mp3")
			sndWOP:Schedule(97, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\countone.mp3")
			sndWOP:Schedule(98, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\mobkill.mp3")
		end
	end
end
...
function mod:SPELL_CAST_START(args)
	if args.spellId == 136954 then
		...
		sndCQ:Play("Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\ex_tt_bmcq.mp3") --幫忙吃球
	elseif args:IsSpellID(138763, 139867, 139869) then--Normal version is 2.2 sec cast. Heroic is 1.4 second cast. LFR is 3.8 sec cast (thus why it has different spellid)
		...
		if mod:IsManaUser() and mod:IsRanged() then
			...
			sndWOP:Play("Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\stopcast.mp3") --停止施法
		else
			sndWOP:Play("Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\ex_tt_dfzj.mp3") --斷法震擊
		end
		if mod:IsHealer() then
			sndWOP:Cancel("Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\ex_tt_tenzj.mp3")
			sndWOP:Schedule(11.8, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\ex_tt_tenzj.mp3") -- 10秒後斷法震擊
		end
		if MyJS() then
			specWarnJSA:Schedule(18.8)
			sndWOP:Schedule(18.8, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\defensive.mp3") --注意減傷
		else
			sndWOP:Schedule(18.8, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\countfour.mp3")
		end		
		sndWOP:Schedule(19.8, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\countthree.mp3")
		sndWOP:Schedule(20.8, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\counttwo.mp3")
		sndWOP:Schedule(21.8, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\countone.mp3")
		VEM.InfoFrame:Hide()
...
local function PowerDelay()
	...
	if power >= 70 and fpower then
		...
		if mod:IsHealer() then
			sndWOP:Schedule(8, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\ex_tt_tenzj.mp3") -- 10秒後斷法震擊
		end
		if MyJS() then
			specWarnJSA:Schedule(15)
			sndWOP:Schedule(15, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\defensive.mp3") --注意減傷
		else
			sndWOP:Schedule(15, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\countfour.mp3")
		end		
		sndWOP:Schedule(16, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\countthree.mp3")
		sndWOP:Schedule(17, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\counttwo.mp3")
		sndWOP:Schedule(18, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\countone.mp3")
	...
	if args.spellId == 138644 and self:IsDifficulty("heroic10", "heroic25") then--Only start on heroic, on normal it's 6 second cd, not worth using timer there
		...
		if mod.Options.MobB then
			if SiphonAnimaCount == 1 then
				sndWOP:Schedule(17, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\ex_tt_echx.mp3")
			elseif SiphonAnimaCount == 2 then
				sndWOP:Cancel("Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\ex_tt_echx.mp3")
				sndWOP:Play("Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\mobkill.mp3")
				sndWOP:Schedule(1, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\mobkill.mp3")
			end
		end
		if mod.Options.MobC then
			if SiphonAnimaCount == 3 then
				sndWOP:Schedule(17, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\ex_tt_schx.mp3")
			elseif SiphonAnimaCount == 4 then
				sndWOP:Cancel("Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\ex_tt_schx.mp3")
				sndWOP:Play("Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\mobkill.mp3")
				sndWOP:Schedule(1, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\mobkill.mp3")
			end
		end
...
function mod:SPELL_AURA_APPLIED(args)
	...
	elseif args.spellId == 138609 then
		...
		if args:IsPlayer() then
			...
			sndWOP:Play("Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\ex_tt_jhzb.mp3") --交換準備
		elseif mod:IsHealer() then		
			sndWOP:Play("Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\ex_tt_wzjh.mp3") --物質交換
		end
