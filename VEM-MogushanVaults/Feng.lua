...
function mod:SPELL_AURA_APPLIED(args)
	...
	elseif args:IsSpellID(118302) then
		...
		sndWOP:Play("Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\ex_mop_nzlt.ogg") --逆轉雷霆
	elseif args:IsSpellID(116784) then
		...
		if args:IsPlayer() then
			...
			sndWOP:Play("Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\firerun.ogg") --火焰點你
	...
	elseif args:IsSpellID(116711) then
		...
		sndWOP:Play("Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\ex_mop_qyhy.ogg") --牽引火焰
	...
	elseif args:IsSpellID(116364) then
		...
		if not AVPlayer then
			...
			sndWOP:Play("Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\ex_mop_mfdd.ogg")--秘法動蕩
		end
		AVend = true
...
function mod:SPELL_AURA_REMOVED(args)
	...
	elseif args:IsSpellID(116018) then
		...
		sndWOPD:Cancel("Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\countfour.ogg")
		sndWOPD:Cancel("Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\countthree.ogg")
		sndWOPD:Cancel("Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\counttwo.ogg")
		sndWOPD:Cancel("Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\countone.ogg")
	elseif args:IsSpellID(116784) then
	...
	elseif args:IsSpellID(116417) then
		...
		if args:IsPlayer() then
			...
			if AVend then
				sndWOP:Play("Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\gather.ogg")--快集合
				sndWOP:Schedule(5, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\scattersoon.ogg")--注意分散
			end
		end
...
function mod:SPELL_CAST_START(args)
	if args:IsSpellID(116018) then
		...
		sndWOP:Play("Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\ex_mop_yldz.ogg") --遠離地震
--		soundEpicenter:Play()
		timerEpicenter:Start()
		sndWOPD:Schedule(6.5, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\countfour.ogg")
		sndWOPD:Schedule(7.5, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\countthree.ogg")
		sndWOPD:Schedule(8.5, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\counttwo.ogg")
		sndWOPD:Schedule(9.5, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\countone.ogg")
	...
	elseif args:IsSpellID(116157, 116295) then
		...
		sndWOP:Play("Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\ex_mop_zydb.ogg") --注意電波
	end
end
...
function mod:OnSync(msg)
	if msg == "Earth" then
		...
		sndWOP:Play("Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\ex_mop_zrxt.ogg") --自然形态
		if self.Options.RangeFrame then
			VEM.RangeCheck:Hide()
		end
	elseif msg == "Flame" then
		...
		sndWOP:Play("Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\ex_mop_hyxt.ogg") --火焰形态
		if self.Options.RangeFrame then
			VEM.RangeCheck:Hide()
		end
	elseif msg == "Purple" then
		...
		sndWOP:Play("Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\ex_mop_mfxt.ogg") --秘法形态
		if self.Options.RangeFrame then
	...
	elseif msg == "Dark" then
		...
		sndWOP:Play("Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\ex_mop_ayxt.ogg") --暗影形態
		if self.Options.RangeFrame then
			VEM.RangeCheck:Hide()
		end
	end
...
function mod:UNIT_SPELLCAST_SUCCEEDED(uId, _, _, _, spellId)
	if spellId == 117203 and self:AntiSpam(2, 1) then--Siphoning Shield
		...
		sndWOP:Play("Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\ex_mop_yldp.ogg") --遠離盾牌
		sndWOP:Schedule(1.5, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\countfour.ogg")
		sndWOP:Schedule(2.5, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\countthree.ogg")
		sndWOP:Schedule(3.5, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\counttwo.ogg")
		sndWOP:Schedule(4.5, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\countone.ogg")
		sndWOP:Schedule(5, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\killspirit.ogg") --靈魂快打
	elseif spellId == 121631 and self:AntiSpam(2, 2) then--Draw Essence.
		...
		sndWOP:Cancel("Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\scattersoon.ogg")
		sndWOPD:Cancel("Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\countfour.ogg")
		sndWOPD:Cancel("Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\countthree.ogg")
		sndWOPD:Cancel("Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\counttwo.ogg")
		sndWOPD:Cancel("Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\countone.ogg")
