...
function mod:SPELL_AURA_APPLIED(args)
	...
	elseif args:IsSpellID(118302) then
		...
		sndWOP:Play("Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\ex_mop_nzlt.mp3") --逆轉雷霆
	elseif args:IsSpellID(116784) then
		...
		if args:IsPlayer() then
			...
			sndWOP:Play("Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\firerun.mp3") --火焰點你
	...
	elseif args:IsSpellID(116711) then
		...
		sndWOP:Play("Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\ex_mop_qyhy.mp3") --牽引火焰
	...
	elseif args:IsSpellID(116364) then
		...
		if not AVPlayer then
			...
			sndWOP:Play("Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\ex_mop_mfdd.mp3")--秘法動蕩
		end
		AVend = true
...
function mod:SPELL_AURA_REMOVED(args)
	...
	elseif args:IsSpellID(116018) then
		...
		sndWOPD:Cancel("Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\countfour.mp3")
		sndWOPD:Cancel("Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\countthree.mp3")
		sndWOPD:Cancel("Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\counttwo.mp3")
		sndWOPD:Cancel("Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\countone.mp3")
	elseif args:IsSpellID(116784) then
	...
	elseif args:IsSpellID(116417) then
		...
		if args:IsPlayer() then
			...
			if AVend then
				sndWOP:Play("Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\gather.mp3")--快集合
				sndWOP:Schedule(5, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\scattersoon.mp3")--注意分散
			end
		end
...
function mod:SPELL_CAST_START(args)
	if args:IsSpellID(116018) then
		...
		sndWOP:Play("Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\ex_mop_yldz.mp3") --遠離地震
--		soundEpicenter:Play()
		timerEpicenter:Start()
		sndWOPD:Schedule(6.5, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\countfour.mp3")
		sndWOPD:Schedule(7.5, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\countthree.mp3")
		sndWOPD:Schedule(8.5, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\counttwo.mp3")
		sndWOPD:Schedule(9.5, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\countone.mp3")
	...
	elseif args:IsSpellID(116157, 116295) then
		...
		sndWOP:Play("Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\ex_mop_zydb.mp3") --注意電波
	end
end
...
function mod:OnSync(msg)
	if msg == "Earth" then
		...
		sndWOP:Play("Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\ex_mop_zrxt.mp3") --自然形态
		if self.Options.RangeFrame then
			VEM.RangeCheck:Hide()
		end
	elseif msg == "Flame" then
		...
		sndWOP:Play("Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\ex_mop_hyxt.mp3") --火焰形态
		if self.Options.RangeFrame then
			VEM.RangeCheck:Hide()
		end
	elseif msg == "Purple" then
		...
		sndWOP:Play("Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\ex_mop_mfxt.mp3") --秘法形态
		if self.Options.RangeFrame then
	...
	elseif msg == "Dark" then
		...
		sndWOP:Play("Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\ex_mop_ayxt.mp3") --暗影形態
		if self.Options.RangeFrame then
			VEM.RangeCheck:Hide()
		end
	end
...
function mod:UNIT_SPELLCAST_SUCCEEDED(uId, _, _, _, spellId)
	if spellId == 117203 and self:AntiSpam(2, 1) then--Siphoning Shield
		...
		sndWOP:Play("Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\ex_mop_yldp.mp3") --遠離盾牌
		sndWOP:Schedule(1.5, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\countfour.mp3")
		sndWOP:Schedule(2.5, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\countthree.mp3")
		sndWOP:Schedule(3.5, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\counttwo.mp3")
		sndWOP:Schedule(4.5, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\countone.mp3")
		sndWOP:Schedule(5, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\killspirit.mp3") --靈魂快打
	elseif spellId == 121631 and self:AntiSpam(2, 2) then--Draw Essence.
		...
		sndWOP:Cancel("Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\scattersoon.mp3")
		sndWOPD:Cancel("Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\countfour.mp3")
		sndWOPD:Cancel("Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\countthree.mp3")
		sndWOPD:Cancel("Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\counttwo.mp3")
		sndWOPD:Cancel("Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\countone.mp3")
