...
local unlock = "Interface\\AddOns\\VEM-TerraceofEndlessSpring\\Textures\\icons\\lock"
local lock = "Interface\\AddOns\\VEM-TerraceofEndlessSpring\\Textures\\icons\\un_lock"
...
local function ensureDisplay()
	...
	close:SetNormalTexture("Interface\\AddOns\\VEM-TerraceofEndlessSpring\\Textures\\icons\\close")
	...
	rangeCircle:SetTexture([[Interface\AddOns\VEM-TerraceofEndlessSpring\Textures\alert_circle]])
	...
	tex:SetTexture("Interface\\AddOns\\VEM-TerraceofEndlessSpring\\Textures\\draghandle")
	tex:SetWidth(16)
	tex:SetHeight(16)
...
local function CLEU(...)
	if not VEM.ShaOfFearAssistEnabled then return end
...
addon:SetScript("OnEvent", function(self, event, ...)
	if event == "ADDON_LOADED" then
		if (...) == "VEM-TerraceofEndlessSpring" then
