...
L:SetMiscLocalization({
	...
	helperMessage	= "It is recommended you use 'Thogar Assist' in combination with VEM on this boss. Available from: http://wow.curseforge.com/addons/thogar-assist/",
