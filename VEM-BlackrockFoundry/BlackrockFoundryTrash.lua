local mod	= VEM:NewMod("BlackrockFoundryTrash", "VEM-BlackrockFoundry")
...
local galakrasMod = VEM:GetModByName("868")--Because for first 10-20 seconds of galakras, EncounterInProcess() return false, so mod.isTrashMod = true won't filter first set of adds
