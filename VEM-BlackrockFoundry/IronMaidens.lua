local mod	= VEM:NewMod(1203, "VEM-BlackrockFoundry", nil, 457)
...
function mod:SPELL_CAST_START(args)
	...
	if not VEM.Options.DontShowFarWarnings then
		noFilter = true
	end
...
function mod:OnSync(msg, guid)
	...
	if (not VEM.Options.DontShowFarWarnings or isPlayerOnBoat()) then return end--Anything below this line doesn't concern people on boat
