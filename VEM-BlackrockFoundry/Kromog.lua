local mod	= VEM:NewMod(1162, "VEM-BlackrockFoundry", nil, 457)
...
local warnCrushingEarth				= mod:NewTargetAnnounce(161923, 3, nil, false)--Players who failed to move. Off by default since announcing failures is not something VEM generally does by default. Can't announce pre cast unfortunately. No detection
