local mod	= VEM:NewMod(1161, "VEM-BlackrockFoundry", nil, 457)
...
local warnOverwhelmingBlows			= mod:NewStackAnnounce(155078, 3, nil, mod:IsTank() or mod:IsHealer())--No special warnings, strats for this revolve around the inferno slice strat, not this debuff, so vem isn't going to say when tanks should taunt here
