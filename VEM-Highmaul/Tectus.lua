local mod	= VEM:NewMod(1195, "VEM-Highmaul", nil, 477)
...
--TODO, figure out what's wrong with VEM-Core stripping most of EJ spellname in specWarnEarthwarper (it's saying "Night - Switch" instead of "Night-Twisted Earthshaper - Switch")
--Tectus
