...
L.UseMasterVolume			= "使用主要聲音頻道來播放VEM音效警報"
L.Latency_Text				= "設定最高延遲同步門檻:%d"
-- Tab: General Timer Options
L.TimerGeneral 				= "綜合VEM計時器選項"
...
L.ShowCombatLogMessage 		= "在聊天視窗顯示VEM戰鬥紀錄訊息"
L.ShowTranscriptorMessage	= "在聊天視窗顯示VEM Transcriptor紀錄訊息"
...
L.Bar_VEMOnly				= "以下選項只支援 \"VEM\" 計時條風格"
...
L.AutologBosses				= "自動使用暴雪戰鬥日誌記錄首領戰鬥(為了<a href=\"http://www.warcraftlogs.com\">|cff3588ffwarcraftlogs.com|r</a>的相容性請於開打前使用/vem pull)"
