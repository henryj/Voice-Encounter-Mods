...
L.ShowCombatLogMessage 			= "在聊天窗口中显示VEM战斗记录"
L.ShowTranscriptorMessage		= "在聊天窗口中显示VEM Transcriptor 记录"
...
L.Bar_VEMOnly				= "以下设置只对 \"VEM\" 计时条有效."
...
L.AutologBosses				= "自动采用官方格式记录日志。 (使用 /vem pull 可提前记录并使得记录更准确，如提前偷药水或是召唤大军。)"
