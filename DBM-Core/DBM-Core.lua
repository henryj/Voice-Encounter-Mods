...
do
	...
	syncHandlers["CPT"] = function(sender)
		...
		if not DBM.Options.DontPlayPTCountdown then
			DBM:Unschedule(SendChatMessage)
			DBM:Unschedule(PlaySoundFile, "Interface\\AddOns\\DBM-Core\\Sounds\\sst\\5.mp3", "Master")
			DBM:Unschedule(PlaySoundFile, "Interface\\AddOns\\DBM-Core\\Sounds\\sst\\4.mp3", "Master")
			DBM:Unschedule(PlaySoundFile, "Interface\\AddOns\\DBM-Core\\Sounds\\sst\\3.mp3", "Master")
			DBM:Unschedule(PlaySoundFile, "Interface\\AddOns\\DBM-Core\\Sounds\\sst\\2.mp3", "Master")
			DBM:Unschedule(PlaySoundFile, "Interface\\AddOns\\DBM-Core\\Sounds\\sst\\1.mp3", "Master")
	...
	syncHandlers["PT"] = function(sender, timer, mapid)
		...
		if not DBM.Options.DontPlayPTCountdown then
			...
			if timer > 5 then DBM:Schedule(timer-5, PlaySoundFile, "Interface\\AddOns\\DBM-Core\\Sounds\\sst\\5.mp3", "Master") end
			if timer > 5 then DBM:Schedule(timer-4, PlaySoundFile, "Interface\\AddOns\\DBM-Core\\Sounds\\sst\\4.mp3", "Master") end
			if timer > 3 then DBM:Schedule(timer-3, PlaySoundFile, "Interface\\AddOns\\DBM-Core\\Sounds\\sst\\3.mp3", "Master") end
			if timer > 3 then DBM:Schedule(timer-2, PlaySoundFile, "Interface\\AddOns\\DBM-Core\\Sounds\\sst\\2.mp3", "Master") end
			if timer > 3 then DBM:Schedule(timer-1, PlaySoundFile, "Interface\\AddOns\\DBM-Core\\Sounds\\sst\\1.mp3", "Master") end
