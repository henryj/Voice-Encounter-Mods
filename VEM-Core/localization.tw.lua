...
VEM_CORE_VERSIONCHECK_FOOTER			= "團隊中有%d玩家正在使用VEM|VEM / %d玩家正在使用Bigwigs"
...
VEM_INSTANCE_INFO_STATUS_UPDATE		= "從%d個玩家獲得訊息，來自%d個VEM|VEM用戶：%d人發送了資料, %d人拒絕回傳資料。繼續為更多回覆等待%d秒..."
