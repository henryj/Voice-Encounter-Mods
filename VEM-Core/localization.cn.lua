...
VEM_CORE_LOAD_GUI_COMBAT			= "无法在战斗中初始化图形界面。请先在非战斗状态打开图形设置界面，之后的战斗中就可以自由打开和关闭该界面了。"
VEM_CORE_LOAD_MOD_COMBAT			= "延迟读取模块 '%s' 直到你脱离战斗"
VEM_CORE_BAD_LOAD				= "VEM检测到你无法完全正确加载当前副本模块(因為你正在战斗中),请在离开战斗后立刻重载介面"

VEM_CORE_LOOT_SPEC_REMINDER			= "你当前的专精为 %s. 你当前的拾取选择为 %s."

VEM_CORE_BIGWIGS_ICON_CONFLICT			= "VEM检测到你同时开启了Bigwigs,请关闭自动标记以避免冲突"

VEM_CORE_COMBAT_STARTED				= "%s作战开始，祝你走运 :)"
VEM_CORE_COMBAT_STARTED_IN_PROGRESS	= "已进行的战斗%s作战开始。祝你走运 :)"
VEM_CORE_SCENARIO_STARTED			= "%s作战开始，祝你走运 :)"
VEM_CORE_BOSS_DOWN					= "%s战斗胜利！用时%s！"
VEM_CORE_BOSS_DOWN_I				= "击败%s！总计%d次胜利。"
VEM_CORE_BOSS_DOWN_L				= "%s战斗胜利！用时%s！上次用时%s，最快用时%s。总计%d次胜利。"
VEM_CORE_BOSS_DOWN_NR				= "%s战斗胜利！用时%s！新的纪录诞生了！原纪录为%s。总计%d次胜利。"
VEM_CORE_SCENARIO_COMPLETE			= "%s战斗胜利！用时%s!"
VEM_CORE_SCENARIO_COMPLETE_L		= "%s战斗胜利！用时%s！上次用时%s，最快用时%s。总计%d次胜利。"
VEM_CORE_SCENARIO_COMPLETE_NR		= "%s战斗胜利！用时%s！新的纪录诞生了！原纪录为%s。总计%d次胜利。"
VEM_CORE_COMBAT_ENDED_AT			= "%s（%s）作战结束，用时%s。"
VEM_CORE_COMBAT_ENDED_AT_LONG		= "%s（%s）作战结束，用时%s。该难度下总计失败%d次。"
VEM_CORE_SCENARIO_ENDED_AT			= "%s战斗胜利！用时%s!"
VEM_CORE_SCENARIO_ENDED_AT_LONG		= "%s战斗胜利！用时%s！总计%d次胜利。"
VEM_CORE_COMBAT_STATE_RECOVERED		= "%s作战%s前开始，正在恢复计时条……"
VEM_CORE_TRANSCRIPTOR_LOG_START		= "Transcriptor开始记录."
VEM_CORE_TRANSCRIPTOR_LOG_END		= "Transcriptor结束记录."
...
VEM_CORE_OPTION_TIMER_COMBAT		= "计时条：战斗开始"
...
VEM_CORE_AUTO_RESPONDED						= "已自动回复密语。"
...
VEM_CORE_AUTO_RESPOND_WHISPER_SCENARIO		= "%s 正在进行战斗： %s (%d/%d people alive)"
VEM_CORE_WHISPER_SCENARIO_END_KILL			= "%s 已完成 %s!"
VEM_CORE_WHISPER_SCENARIO_END_KILL_STATS	= "%s 已完成 %s! 总计 %d 次胜利."
VEM_CORE_WHISPER_SCENARIO_END_WIPE			= "%s 未能完成 %s."
VEM_CORE_WHISPER_SCENARIO_END_WIPE_STATS	= "%s 未能完成 %s. 该难度下总计 %d 次失败."
...
VEM_CORE_VERSIONCHECK_FOOTER			= "团队中有%d玩家正在使用VEM|VEM / %d玩家正在使用Bigwigs"
...
VEM_CORE_UPDATEREMINDER_HEADER		= "你的Voice Encounter Mods版本已过期。\n你可以在如下地址下载到新版本%s（r%d）："
VEM_CORE_UPDATEREMINDER_HEADER_ALPHA	= "你的Voice Encounter Mods版本已过期至少 %d 个版本。"
VEM_CORE_UPDATEREMINDER_FOOTER		= (IsMacClient() and "Cmd-C" or "Ctrl-C")  ..  "复制地址到剪切板。"
VEM_CORE_UPDATEREMINDER_FOOTER_GENERIC	= (IsMacClient() and "Cmd-C" or "Ctrl-C")  ..  "复制地址到剪切板。"
VEM_CORE_UPDATEREMINDER_NOTAGAIN	= "检测到新版本后弹出提示框"
VEM_CORE_UPDATEREMINDER_DISABLE		= "警告：你的VEM已经过时相当多的版本（%d个版本），它已被禁用，直到你更新。这是為了确保它不会导致你或其他团队成员出错。"
...
--	"/vem version2: 进行团队范围的VEM版本检测并密语给那些使用过期版本的玩家（也可使用：ver2）",
	...
	"/vem timer <x> <文本>：开始一个以<文本>为名称的时间为<x>秒的倒计时",
...
VEM_CORE_ANNOUNCE_PULL				= "%d秒后开怪"
VEM_CORE_ANNOUNCE_PULL_NOW			= "开怪！"
VEM_CORE_ANNOUNCE_PULL_CANCEL		= "取消了开怪倒计时"

VEM_CORE_ACHIEVEMENT_TIMER_SPEED_KILL = "成就：快速击杀"
...
VEM_INSTANCE_INFO_STATUS_UPDATE		= "已收到%d名团员的进度回复（已安装VEM|VEM的团员有%d名）：%d人接受请求，%d人拒绝。生成数据需要约%d秒，请等待。"
...
VEM_INSTANCE_INFO_STATS_NO_RESPONSE	= "新版VEM未安装：%s"
...
VEM_CORE_LAG_CHECKING				= "延时检测--五秒后反馈结果..."
VEM_CORE_LAG_HEADER					= "Voice Encounter Mods - 延时检测"
