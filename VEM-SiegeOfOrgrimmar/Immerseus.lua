...
function mod:OnCombatStart(delay)
	...
	sndWOP:Schedule(16-delay, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\ex_so_xwzb.ogg")--漩渦準備
	sndWOP:Schedule(17-delay, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\countthree.ogg")
	sndWOP:Schedule(18-delay, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\counttwo.ogg")
	sndWOP:Schedule(19-delay, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\countone.ogg")
...
function mod:SPELL_CAST_START(args)
	if args.spellId == 143436 then
		...
		specWarnBreath:Show()
		if mod:IsTank() then
			sndWOP:Play("Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\ex_so_zbcj.ogg") --準備衝擊
		end
		timerBreathCD:Start()
	elseif args.spellId == 143309 then
		...
		specWarnSwirl:Show()
		timerSwirl:Start()
		sndWOP:Cancel("Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\ex_so_xwzb.ogg")
		...
		sndWOP:Play("Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\ex_so_xw.ogg") --漩渦
		sndWOP:Schedule(44, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\ex_so_xwzb.ogg")--漩渦準備
...
function mod:SPELL_AURA_APPLIED_DOSE(args)
	if args:IsSpellID(143579) and args:IsPlayer() then
		if (args.amount or 1) >= 3 then
			...
			sndPZ:Play("Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\stopatk.ogg") --注意停手
		end
	end
end
...
function mod:SPELL_AURA_REMOVED(args)
	...
	elseif args:IsSpellID(143579) and args:IsPlayer() then
		if needwarnsafe then
			sndPZ:Play("Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\safenow.ogg") --安全
			needwarnsafe = false
		end
	end
end
	...
	if spellId == 145377 or spellId == 143498 then
		if needwarndr then
			...
			if MyJS() then
				...
				sndWOP:Play("Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\holdit.ogg")
			end
		end
	end
end
...
function mod:UNIT_SPELLCAST_SUCCEEDED(uId, _, _, _, spellId)
	...
	elseif spellId == 143578 then--Swelling Corruption
		...
		sndWOP:Play("Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\ex_so_pz.ogg") --膨脹
	end
end
...
function mod:CHAT_MSG_RAID_BOSS_EMOTE(msg, _, _, _, target)
	if msg:find("spell:143469") then--Reforms
		warnReform:Show()
		needwarndr = false
		sndWOP:Play("Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\ex_so_fljs.ogg") --分裂結束
		timerBreathCD:Start(14)
		timerSwirlCD:Start(24)
		sndWOP:Schedule(20, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\ex_so_xwzb.ogg")--漩渦準備
	...
	elseif msg:find("spell:143020") then--split
		...
		sndWOP:Cancel("Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\counttwo.ogg")
		sndWOP:Cancel("Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\countone.ogg")
		sndWOP:Play("Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\ex_so_fl.ogg") --分裂開始
