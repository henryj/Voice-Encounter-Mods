...
local function updateInfoFrame()
	if mod.Options.InfoFrame then
		VEM.InfoFrame:SetHeader(GetSpellInfo(143020))
		VEM.InfoFrame:Show(2, "other", killcount, L.kill, cleancount, L.clean)
	end
end
...
function mod:OnCombatStart(delay)
	...
	sndWOP:Schedule(16-delay, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\ex_so_xwzb.mp3")--漩渦準備
	sndWOP:Schedule(17-delay, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\countthree.mp3")
	sndWOP:Schedule(18-delay, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\counttwo.mp3")
	sndWOP:Schedule(19-delay, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\countone.mp3")
...
function mod:SPELL_CAST_START(args)
	if args.spellId == 143436 then
		...
		specWarnBreath:Show()
		if mod:IsTank() then
			sndWOP:Play("Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\ex_so_zbcj.mp3") --準備衝擊
		end
		timerBreathCD:Start()
	elseif args.spellId == 143309 then
		...
		specWarnSwirl:Show()
		timerSwirl:Start()
		sndWOP:Cancel("Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\ex_so_xwzb.mp3")
		...
		sndWOP:Play("Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\ex_so_xw.mp3") --漩渦
		sndWOP:Schedule(44, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\ex_so_xwzb.mp3")--漩渦準備
...
function mod:SPELL_AURA_APPLIED_DOSE(args)
	if args:IsSpellID(143579) and args:IsPlayer() then
		if (args.amount or 1) >= 3 then
			...
			sndPZ:Play("Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\stopatk.mp3") --注意停手
		end
	end
end
...
function mod:SPELL_AURA_REMOVED(args)
	...
	elseif args:IsSpellID(143579) and args:IsPlayer() then
		if needwarnsafe then
			sndPZ:Play("Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\safenow.mp3") --安全
			needwarnsafe = false
		end
	end
end
	...
	if spellId == 145377 or spellId == 143498 then
		if needwarndr then
			...
			if MyJS() then
				...
				sndWOP:Play("Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\holdit.mp3")
			end
		end
	end
end
...
function mod:UNIT_SPELLCAST_SUCCEEDED(uId, _, _, _, spellId)
	...
	elseif spellId == 143578 then--Swelling Corruption
		...
		sndWOP:Play("Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\ex_so_pz.mp3") --膨脹
	end
end
...
function mod:CHAT_MSG_RAID_BOSS_EMOTE(msg, _, _, _, target)
	if msg:find("spell:143469") then--Reforms
		warnReform:Show()
		needwarndr = false
		sndWOP:Play("Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\ex_so_fljs.mp3") --分裂結束
		timerBreathCD:Start(14)
		timerSwirlCD:Start(24)
		sndWOP:Schedule(20, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\ex_so_xwzb.mp3")--漩渦準備
		sndWOP:Schedule(21, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\countthree.mp3")
		sndWOP:Schedule(22, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\counttwo.mp3")
		sndWOP:Schedule(23, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\countone.mp3")
		if self:IsDifficulty("heroic10", "heroic25") then
	...
	elseif msg:find("spell:143020") then--split
		...
		sndWOP:Cancel("Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\counttwo.mp3")
		sndWOP:Cancel("Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\countone.mp3")
		sndWOP:Play("Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\ex_so_fl.mp3") --分裂開始
