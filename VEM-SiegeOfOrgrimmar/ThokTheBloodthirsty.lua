local mod	= VEM:NewMod(851, "VEM-SiegeOfOrgrimmar", nil, 369)
...
local function checkbossrange()
	if UnitExists("boss1") then
		...
		if minrange and maxrange then
			if minrange < 40 then
				VEM:ShowLTSpecialWarning(minrange.." - "..maxrange, 0, 1, 0)
			else
				VEM:ShowLTSpecialWarning(minrange.." - "..maxrange, 1, 0, 0)
			end
		end	
	end
	if phase == 2 then
...
function mod:OnCombatStart(delay)
	...
	if self:IsDifficulty("lfr25") then
		...
		sndPX:Schedule(16-delay, "Interface\\AddOns\\VEM-Core\\extrasounds\\"..VEM.Options.CountdownVoice.."\\aesoon.mp3")	
		sndPX:Schedule(17-delay, "Interface\\AddOns\\VEM-Core\\extrasounds\\"..VEM.Options.CountdownVoice.."\\countthree.mp3")
		sndPX:Schedule(18-delay, "Interface\\AddOns\\VEM-Core\\extrasounds\\"..VEM.Options.CountdownVoice.."\\counttwo.mp3")
		sndPX:Schedule(19-delay, "Interface\\AddOns\\VEM-Core\\extrasounds\\"..VEM.Options.CountdownVoice.."\\countone.mp3")
	else
		...
		sndPX:Schedule(13-delay, "Interface\\AddOns\\VEM-Core\\extrasounds\\"..VEM.Options.CountdownVoice.."\\countone.mp3")
	end
...
function mod:SPELL_CAST_SUCCESS(args)
	if args.spellId == 143343 then--Assumed, 2 second channel but "Instant" cast flagged, this generally means SPELL_AURA_APPLIED
		...
		sndPX:Cancel("Interface\\AddOns\\VEM-Core\\extrasounds\\"..VEM.Options.CountdownVoice.."\\aesoon.mp3")
		sndPX:Cancel("Interface\\AddOns\\VEM-Core\\extrasounds\\"..VEM.Options.CountdownVoice.."\\countthree.mp3")
		sndPX:Cancel("Interface\\AddOns\\VEM-Core\\extrasounds\\"..VEM.Options.CountdownVoice.."\\counttwo.mp3")
		sndPX:Cancel("Interface\\AddOns\\VEM-Core\\extrasounds\\"..VEM.Options.CountdownVoice.."\\countone.mp3")
		if self:IsDifficulty("lfr25") then
			timerDeafeningScreechCD:Start(18, screechCount+1)
			sndPX:Schedule(15-delay, "Interface\\AddOns\\VEM-Core\\extrasounds\\"..VEM.Options.CountdownVoice.."\\aesoon.mp3")	
			sndPX:Schedule(16-delay, "Interface\\AddOns\\VEM-Core\\extrasounds\\"..VEM.Options.CountdownVoice.."\\countthree.mp3")
			sndPX:Schedule(17-delay, "Interface\\AddOns\\VEM-Core\\extrasounds\\"..VEM.Options.CountdownVoice.."\\counttwo.mp3")
			sndPX:Schedule(18-delay, "Interface\\AddOns\\VEM-Core\\extrasounds\\"..VEM.Options.CountdownVoice.."\\countone.mp3")
		else
			...
			if screechTimers[screechCount] and screechTimers[screechCount] > 2.2 then
				if screechTimers[screechCount] > 3.2 then
					sndPX:Schedule(screechTimers[screechCount+1] - 3.2, "Interface\\AddOns\\VEM-Core\\extrasounds\\"..VEM.Options.CountdownVoice.."\\aesoon.mp3")
				end
				sndPX:Schedule(screechTimers[screechCount+1] - 2.2, "Interface\\AddOns\\VEM-Core\\extrasounds\\"..VEM.Options.CountdownVoice.."\\countthree.mp3")
				sndPX:Schedule(screechTimers[screechCount+1] - 1.2, "Interface\\AddOns\\VEM-Core\\extrasounds\\"..VEM.Options.CountdownVoice.."\\counttwo.mp3")
				sndPX:Schedule(screechTimers[screechCount+1] - 0.2, "Interface\\AddOns\\VEM-Core\\extrasounds\\"..VEM.Options.CountdownVoice.."\\countone.mp3")
			end
		end
...
function mod:SPELL_AURA_APPLIED(args)
	if args.spellId == 143411 then
		...
		if self.Options.LTRange then
			VEM:ShowLTSpecialWarning(GetSpellInfo(143343)..":"..screechCount, 0, 1, 0)
		end
		if MyJS() then
...
--DELETE		soundFixate:Play()
	...
	elseif args.spellId == 143800 and args:IsPlayer() then
		...
		if amount >= 3 then
			...
			if amount == 4 then
				sndWOP:Play("Interface\\AddOns\\VEM-Core\\extrasounds\\"..VEM.Options.CountdownVoice.."\\ex_so_zybd.mp3") --注意冰凍
			end
		end
	elseif args.spellId == 143777 then
		...
		if self:AntiSpam(3, 1) then
			...
			if mod:IsDps() then
				sndWOP:Play("Interface\\AddOns\\VEM-Core\\extrasounds\\"..VEM.Options.CountdownVoice.."\\ex_so_bmkd.mp3") -- 冰墓快打
			end
		end
...
function mod:SPELL_AURA_REMOVED(args)
	...
	elseif args.spellId == 143440 then
		...
		if self:IsDifficulty("lfr25") then
			...
			sndPX:Schedule(16, "Interface\\AddOns\\VEM-Core\\extrasounds\\"..VEM.Options.CountdownVoice.."\\aesoon.mp3")
			sndPX:Schedule(17, "Interface\\AddOns\\VEM-Core\\extrasounds\\"..VEM.Options.CountdownVoice.."\\countthree.mp3")
			sndPX:Schedule(18, "Interface\\AddOns\\VEM-Core\\extrasounds\\"..VEM.Options.CountdownVoice.."\\counttwo.mp3")
			sndPX:Schedule(19, "Interface\\AddOns\\VEM-Core\\extrasounds\\"..VEM.Options.CountdownVoice.."\\countone.mp3")
		else
			timerDeafeningScreechCD:Start(nil, 1)
			sndPX:Schedule(10, "Interface\\AddOns\\VEM-Core\\extrasounds\\"..VEM.Options.CountdownVoice.."\\aesoon.mp3")
			sndPX:Schedule(11, "Interface\\AddOns\\VEM-Core\\extrasounds\\"..VEM.Options.CountdownVoice.."\\countthree.mp3")
			sndPX:Schedule(12, "Interface\\AddOns\\VEM-Core\\extrasounds\\"..VEM.Options.CountdownVoice.."\\counttwo.mp3")
			sndPX:Schedule(13, "Interface\\AddOns\\VEM-Core\\extrasounds\\"..VEM.Options.CountdownVoice.."\\countone.mp3")
		end
		if self.Options.RangeFrame and not self:IsDifficulty("lfr25") then
			if self:IsDifficulty("normal10", "heroic10") then
				VEM.RangeCheck:Show(10, nil, nil, 4)
...
--DELETE	soundBloodFrenzy:Play()
	...
	elseif spellId == 143971 then
		...
		timerAcidBreathCD:Start()
		sndWOP:Play("Interface\\AddOns\\VEM-Core\\extrasounds\\"..VEM.Options.CountdownVoice.."\\ex_so_dyqh.mp3") --毒液恐龍
		phase = 1
	elseif spellId == 143968 then
		...
		sndWOP:Play("Interface\\AddOns\\VEM-Core\\extrasounds\\"..VEM.Options.CountdownVoice.."\\ex_so_bsqh.mp3") --冰霜恐龍
		phase = 1
	elseif spellId == 143970 then
		...
		timerScorchingBreathCD:Start()
		sndWOP:Play("Interface\\AddOns\\VEM-Core\\extrasounds\\"..VEM.Options.CountdownVoice.."\\ex_so_lyqh.mp3") --烈焰恐龍
		phase = 1
	end
end
