...
function mod:OnCombatStart(delay)
	...
	sndWOP:Schedule(40, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\mobsoon.ogg") --準備小怪
	sndWOP:Schedule(41, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\countone.ogg")
--	countdownAdds:Start()
...
function mod:SPELL_CAST_START(args)
	if args.spellId == 143872 then
		...
		sndWOP:Play("Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\ex_so_xff.ogg") --旋風斧
	...
	elseif args.spellId == 143431 then
		...
		if source == UnitName("target") or source == UnitName("focus") then
			...
			sndIFS:Play("Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\kickcast.ogg") --快打斷
		end
	...
	elseif args.spellId == 143473 then
		...
		if source == UnitName("target") or source == UnitName("focus") then
			...
			sndISM:Play("Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\kickcast.ogg") --快打斷
...
function mod:SPELL_CAST_SUCCESS(args)
	if args.spellId == 143589 then
		...
		sndWOP:Play("Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\ex_so_zdzt.ogg") --戰鬥姿態
	...
	elseif args.spellId == 143594 then
		...
		sndWOP:Play("Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\ex_so_kbzt.ogg") --狂暴姿態
		if mod.Options.InfoFrame then
		...
		sndWOP:Schedule(55, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\ex_so_fyzb.ogg") --防禦姿態準備
	...
	elseif args.spellId == 143593 then
		...
		if (source == UnitName("target")) and (not UnitDebuff("player", sunder)) then
			sndWOP:Play("Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\stopattack.ogg") --注意停手			
		else
			sndWOP:Play("Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\ex_so_fyzt.ogg") --防禦姿態
		end
		if mod.Options.InfoFrame then
	...
	elseif args.spellId == 143536 then
		...
		sndWOP:Play("Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\ex_so_zqkd.ogg") --戰旗快打
	elseif args.spellId == 143474 then
		warnHealingTideTotem:Show()
		specWarnHealingTideTotem:Show()
		sndWOP:Play("Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\ex_so_ttkd.ogg") --圖騰快打
...
function mod:SPELL_AURA_APPLIED(args)
	...
	elseif args.spellId == 143484 then
		...
		sndWOP:Schedule(11, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\specialsoon.ogg") --準備特別技能
...
--		countdownCoolingOff:Start()
	elseif args.spellId == 143480 then
		...
		if args:IsPlayer() then
			...
			sndWOP:Schedule(1, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\ex_so_ckkp.ogg") --快跑 刺客點你
		else
	...
	elseif args.spellId == 143882 then
		if args:IsPlayer() then
			...
			sndWOP:Schedule(2, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\runout.ogg")
		end
	elseif args.spellId == 143475 and not args:IsDestTypePlayer() then
		...
		sndDS:Play("Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\ex_so_dun.ogg") --驅散大地盾
...
--		sndWOP:Play("Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\killmob.ogg") --小怪快打
		sndWOP:Schedule(39, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\mobsoon.ogg")
...
--		countdownAdds:Start()
	...
	elseif msg == L.allForces then
		...
		specWarnAdds:Show(0)
		sndWOP:Cancel("Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\mobsoon.ogg")
		sndWOP:Play("Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\ptwo.ogg") --第二阶段
	end
end
...
function mod:UNIT_SPELLCAST_SUCCEEDED(uId, _, _, _, spellId)
	if spellId == 143500 then--Faster than combat log by 0.3-0.5 seconds
		...
		sndWOP:Play("Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\ex_so_yzkd.ogg") --餘震快躲
	end
end
