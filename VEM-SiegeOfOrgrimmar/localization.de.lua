...
L:SetMiscLocalization({
	nameset		= "Galakras",
	wasteOfTime		= "Gut gemacht! Landungstrupps, angetreten! Infanterie, nach vorn!",-- alliance trigger
	...
	newForces1	= "Da kommen sie!",--Jaina's line, alliance
	newForces1H	= "Holt sie schnell vom Himmel, damit ich sie erwürgen kann.",--Sylva's line, horde
