...
function mod:OnCombatStart(delay)
	...
	sndWOP:Schedule(117, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\ex_so_qgzb.mp3") --強攻階段準備
...
function mod:SPELL_CAST_START(args)
	if args.spellId == 144483 then--Siege mode transition
		...
		sndWOP:Cancel("Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\ex_so_qgzb.mp3")
		...
		sndWOP:Schedule(60, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\ex_so_tjzb.mp3") --突擊階段準備
		sndWOP:Schedule(61, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\countthree.mp3")
		sndWOP:Schedule(62, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\counttwo.mp3")
		sndWOP:Schedule(63, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\countone.mp3")
	elseif args.spellId == 144485 then
		...
		sndWOP:Play("Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\ex_so_zbjt.mp3") --準備擊飞		
		if MyJS() then
		...
		sndWOP:Schedule(2, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\counttwo.mp3")
		sndWOP:Schedule(3, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\countone.mp3")
	end
end
...
function mod:UNIT_SPELLCAST_SUCCEEDED(uId, _, _, _, spellId)
	...
	elseif spellId == 144296 then--absolutely do NOT add 144218 to this. 144218 is an every 0.4 second periodic trigger that fires after 144296
		...
		sndWOP:Play("Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\ex_so_dckd.mp3")--地刺快躲
	...
	elseif spellId == 144673 then
		...
		sndWOP:Play("Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\ex_so_dlcx.mp3")--地雷出現
	...
	elseif spellId == 146359 then--Regeneration (Assault Mode power regen activation)
		...
		if siegeMode == true then--don't start timer on pull regenerate, pull regenerate is 5 seconds longer than rest of them
			...
			sndWOP:Cancel("Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\ex_so_tjzb.mp3")
			sndWOP:Cancel("Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\countthree.mp3")
			sndWOP:Cancel("Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\counttwo.mp3")
			sndWOP:Cancel("Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\countone.mp3")
			sndWOP:Play("Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\phasechange.mp3") --階段轉換
			sndWOP:Schedule(112, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\ex_so_qgzb.mp3") --強攻階段準備
			sndWOP:Schedule(113, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\countthree.mp3")
			sndWOP:Schedule(114, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\counttwo.mp3")
			sndWOP:Schedule(115, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\countone.mp3")
			siegeMode = false
		end
		--[[if self:IsDifficulty("heroic10", "heroic25") then
