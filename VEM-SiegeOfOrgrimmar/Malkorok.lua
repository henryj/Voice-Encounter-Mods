...
function mod:OnCombatStart(delay)
	...
	sndWOP:Schedule(67, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\ex_so_yszb.ogg") --亞煞極之息準備
...
--			soundDisplacedEnergy:Play()
			...
			sndWOP:Schedule(1, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\runout.ogg")
			sndWOP:Schedule(2.5, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\countseven.ogg")
			sndWOP:Schedule(3.5, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\countsix.ogg")
			sndWOP:Schedule(4.5, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\countfive.ogg")
			sndWOP:Schedule(5.5, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\countfour.ogg")
			sndWOP:Schedule(6.5, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\countthree.ogg")
			sndWOP:Schedule(7.5, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\counttwo.ogg")
			sndWOP:Schedule(8.5, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\countone.ogg")
		end
		if self.Options.HudMAP then
...
function mod:SPELL_AURA_REMOVED(args)
	if args.spellId == 142913 then
		...
		if args:IsPlayer() then
			...
			sndWOP:Cancel("Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\runout.ogg")
...
--		countdownImplodingEnergy:Start()
		...
		sndWOP:Play("Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\ex_so_yhz.ogg") --圓弧斬快躲
		sndWOP:Schedule(5, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\ex_so_fscq.ogg") --分散踩圈
		if MyJS() then
			sndWOP:Schedule(5.8, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\defensive.ogg") --注意減傷
			sndWOP:Schedule(6.5, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\defensive.ogg")
		end
