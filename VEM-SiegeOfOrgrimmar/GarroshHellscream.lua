...
function mod:OnCombatStart(delay)
	...
	sndGC:Schedule(15, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\ex_so_gczb.ogg") --攻城師準備
	timerHellscreamsWarsongCD:Start(22-delay)
	if not mod:IsDps() then
		sndWOP:Schedule(19, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\ex_so_zgzb.ogg") --戰歌準備
	end
	timerFarseerWolfRiderCD:Start(30-delay)
	if not mod:IsHealer() then
		sndWOP:Schedule(25, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\ex_so_lqzb.ogg") --狼騎兵準備
	end
end
...
function mod:SPELL_CAST_START(args)
	if args.spellId == 144583 then
		...
		if ((mod.Options.optDD == "DD1") and (healcount == 1)) or ((mod.Options.optDD == "DD2") and (healcount == 2)) or ((mod.Options.optDD == "alldd") and (source == UnitName("target") or source == UnitName("focus"))) then
			...
			sndWOP:Cancel("Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\interruptsoon.ogg")
		...
		if ((mod.Options.optDD == "DD1") and (healcount == 2)) or ((mod.Options.optDD == "DD2") and (healcount == 1)) then
			sndWOP:Schedule(7, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\interruptsoon.ogg") --打斷準備
		end
...
--		end		
	...
	elseif args.spellId == 144969 then
		...
		if MyJS("AN") then
			...
			sndWOP:Schedule(0.7, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\defensive.ogg")
		end
	elseif args:IsSpellID(144985, 145037) then
		...
		sndWOP:Cancel("Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\ex_so_hxzb.ogg")
		...
		sndWOP:Play("Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\ex_so_hxkd.ogg") --漩渦快躲
		sndWOP:Schedule(47, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\ex_so_hxzb.ogg") --漩渦準備
		sndWOP:Schedule(48, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\countthree.ogg")
		sndWOP:Schedule(49, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\counttwo.ogg")
		sndWOP:Schedule(50, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\countone.ogg")
...
--[[		self:Schedule(8, function()
	...
	elseif args.spellId == 147120 then
		...
		sndWOP:Schedule(8, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\countfive.ogg")
		sndWOP:Schedule(9, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\countfour.ogg")
		sndWOP:Schedule(10, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\countthree.ogg")
		sndWOP:Schedule(11, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\counttwo.ogg")
		sndWOP:Schedule(12, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\countone.ogg")
		sndWOP:Schedule(13, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\gather.ogg")--快集合
		timerBombardment:Start()
		if Bombcount == 1 then
			timerBombardmentCD:Start()
			sndWOP:Schedule(50, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\ex_so_zbhz.ogg") --準備轟炸
			sndWOP:Schedule(51, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\countfour.ogg")
			sndWOP:Schedule(52, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\countthree.ogg")
			sndWOP:Schedule(53, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\counttwo.ogg")
			sndWOP:Schedule(54, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\countone.ogg")
		else
			timerBombardmentCD:Start(40)
			sndWOP:Schedule(35, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\ex_so_zbhz.ogg")
			sndWOP:Schedule(36, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\countfour.ogg")
...
function mod:SPELL_INTERRUPT(args)
	...
	if cid == 71983 then
		if ((mod.Options.optDD == "DD1H") and (shmddcount % 4 == 0)) or ((mod.Options.optDD == "DD2H") and (shmddcount % 4 == 1)) or ((mod.Options.optDD == "DD3H") and (shmddcount % 4 == 2)) or ((mod.Options.optDD == "DD4H") and (shmddcount % 4 == 3))	then
			sndWOP:Schedule(0.1, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\interruptsoon.ogg") --打斷準備
		end
	end
end
...
--		checknexttouchOfYShaarj("desecrate")
	elseif args:IsSpellID(145065, 145171) then
		...
		sndWOP:Play("Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\ex_so_xkkd.ogg") --心控快打
		if phase == 3 then
...
function mod:SPELL_AURA_APPLIED(args)
	...
	elseif args:IsSpellID(145183, 145195) then
		...
		if amount >= 3 then
			if args:IsPlayer() then
				...
				if mod:IsTank() then
					sndWOP:Play("Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\changemt.ogg") --換坦
				end
			end
		end
	elseif args.spellId == 144585 then
		...
		if not mod:IsHealer() then
			sndWOP:Cancel("Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\ex_so_lqzb.ogg")
			sndWOP:Play("Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\ex_so_lqcx.ogg") --狼騎兵出現
			sndWOP:Schedule(45, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\ex_so_lqzb.ogg") --狼騎兵準備
		end
		healcount = 0
		shmddcount = 0
		if mod.Options.optDD == "DD1" then
			sndWOP:Schedule(10, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\interruptsoon.ogg") --打斷準備
		end
	...
	elseif args.spellId == 147209 then
		...
		if args:IsPlayer() then
			...
			yellMalice:Yell()
			sndWOP:Play("Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\ex_so_eydn.ogg") --惡意點你
			if self.Options.LTIP then
				VEM:ShowLTSpecialWarning(GetSpellInfo(147209).."("..EYcount..")", 1, 0, 0, 1, 147209, 15, 15)
			end
		else
			sndWOP:Play("Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\ex_so_ey.ogg") --惡意
			if EYcount == 1 then
				sndWOP:Schedule(0.4, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\countone.ogg")
			elseif EYcount == 2 then
				sndWOP:Schedule(0.4, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\counttwo.ogg")
			elseif EYcount == 3 then
				sndWOP:Schedule(0.4, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\countthree.ogg")
			elseif EYcount == 4 then
				sndWOP:Schedule(0.4, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\countfour.ogg")
			elseif EYcount == 5 then
				sndWOP:Schedule(0.4, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\countfive.ogg")
			elseif EYcount == 6 then
				sndWOP:Schedule(0.4, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\countsix.ogg")
			end
		end
...
--			countdownPowerIronStar:Cancel()
			sndWOP:Cancel("Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\ex_so_tqzb.ogg")
			sndWOP:Cancel("Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\ex_so_tqkd.ogg")
			sndWOP:Play("Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\ex_so_tqch.ogg") --鐵球摧毀
		end
...
function mod:UNIT_SPELLCAST_SUCCEEDED(uId, _, _, _, spellId)
	if spellId == 144821 then--Warsong. Does not show in combat log
		...
		if not mod:IsDps() then
			sndWOP:Play("Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\ex_so_zg.ogg") --戰歌
			sndWOP:Schedule(39, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\ex_so_zgzb.ogg") --戰歌準備
		end
	elseif spellId == 145235 then--Throw Axe At Heart
		timerSiegeEngineerCD:Cancel()
		sndGC:Cancel("Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\ex_so_gczb.ogg")
		timerFarseerWolfRiderCD:Cancel()
		timerDesecrateCD:Cancel()
		timerHellscreamsWarsongCD:Cancel()
		if not mod:IsDps() then
			sndWOP:Cancel("Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\ex_so_zgzb.ogg")
		end
...
--		countdownWhirlingCorruption:Start(30)			
		sndWOP:Schedule(26, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\ex_so_hxzb.ogg") --漩渦準備
		sndWOP:Schedule(27.5, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\countthree.ogg")
		sndWOP:Schedule(28.5, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\counttwo.ogg")
		sndWOP:Schedule(29.5, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\countone.ogg")
--		timerEnterRealm:Start()
...
--		countdownTouchOfYShaarj:Start(30)
		...
		sndWOP:Schedule(45, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\ex_so_hxzb.ogg") --漩渦準備
--		countdownWhirlingCorruption:Start(47.5)
	elseif spellId == 146984 then--Phase 4 trigger
		...
		sndWOP:Schedule(65, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\ex_so_zbhz.ogg") --準備轟炸
		sndWOP:Schedule(66, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\countfour.ogg")
		sndWOP:Schedule(67, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\countthree.ogg")
		sndWOP:Schedule(68, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\counttwo.ogg")
		sndWOP:Schedule(69, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\countone.ogg")
...
function mod:CHAT_MSG_RAID_BOSS_EMOTE(msg, _, _, _, target)
	if msg:find("spell:144616") then
		...
		sndGC:Play("Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\ex_so_gckd.ogg") --攻城師快打
		if not firstIronStar then
			firstIronStar = true
			timerSiegeEngineerCD:Start(45)
			sndGC:Schedule(40, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\ex_so_gczb.ogg") --攻城師準備
		else
			timerSiegeEngineerCD:Start()
			sndGC:Schedule(35, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\ex_so_gczb.ogg")
		end
...
--		countdownPowerIronStar:Start()
		...
		if mod:IsDifficulty("heroic10", "heroic25") then
			...
			if MyJS("TQ") then
				sndWOP:Schedule(17.5, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\defensive.ogg")
				sndWOP:Schedule(18, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\countfour.ogg")
				sndWOP:Schedule(19, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\countthree.ogg")
				sndWOP:Schedule(20, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\counttwo.ogg")
				sndWOP:Schedule(21, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\countone.ogg")
			end
		else
			warnFireUnstableIronStar:Schedule(16.5)
			specWarnFireUnstableIronStar:Schedule(16.5)
			sndWOP:Schedule(16.5, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\ex_so_tqkd.ogg") --鐵球快躲
		end
	elseif msg:find("spell:147047") then
		warnFireUnstableIronStar:Show()
		specWarnFireUnstableIronStar:Show()
		sndWOP:Play("Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\ex_so_tqzb.ogg") --鐵球準備
	end
end
...
function mod:UNIT_POWER_FREQUENT(uId)
	...
	if power == 93 and self:AntiSpam(10, 2) then
		sndNL:Play("Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\energyhigh.ogg")
	end
	if power == 95 and self:AntiSpam(10, 2) then
		sndNL:Play("Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\count95.ogg")
	end
	if power == 96 and self:AntiSpam(10, 3) then
		sndNL:Play("Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\count96.ogg")
	end
	if power == 97 and self:AntiSpam(10, 4) then
		sndNL:Play("Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\count97.ogg")
	end
	if power == 98 and self:AntiSpam(10, 5) then
		sndNL:Play("Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\count98.ogg")
	end
	if power == 99 and self:AntiSpam(10, 6) then
		sndNL:Play("Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\count99.ogg")
	end
	if power == 100 and self:AntiSpam(10, 7) then
		sndNL:Play("Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\kickcast.ogg")
	end
end