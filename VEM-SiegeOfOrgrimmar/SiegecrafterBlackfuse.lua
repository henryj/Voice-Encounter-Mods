...
function mod:DeathFromAboveTarget(sGUID)
	...
	if targetname == UnitName("player") then
		...
		sndWOP:Play("Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\ex_so_sctj.ogg") --死從
	else
		...
		if uId then
			...
			if inRange and inRange < 20 then
				...
				sndWOP:Play("Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\ex_so_sctj.ogg")
			end
		end
	end
end
...
function mod:SPELL_CAST_START(args)
	...
	elseif args.spellId == 144208 then
		...
		sndFMD:Schedule(3, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\ex_so_fmjd.ogg") --伐木機快打
	end
end
...
--		timerShockwaveMissileActive:Start()
	...
	elseif args.spellId == 145774 then
		...
		if cid == 71638 then
			sndWOP:Play("Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\ex_so_fdqh.ogg") --飛彈強化
		elseif cid == 71752 then
			sndWOP:Play("Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\ex_so_jgqh.ogg") --激光強化
		elseif cid == 71696 then
			sndWOP:Play("Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\ex_so_ccqh.ogg") --磁場強化
		else
			sndWOP:Play("Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\ex_so_dlqh.ogg") --地雷強化
		end
	elseif args.spellId == 145444 then
		...
		if OverloadCount == 3 then
			sndCZ4:Schedule(6, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\ex_so_bh_4cz.ogg") --超載4
			sndCZ4:Schedule(7.5, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\defensive.ogg") --注意減傷
			sndCZ4:Schedule(8.2, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\defensive.ogg")
		elseif OverloadCount == 4 then
			sndCZ5:Schedule(6, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\ex_so_bh_5cz.ogg") --超載5
			sndCZ5:Schedule(7.5, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\defensive.ogg")
			sndCZ5:Schedule(8.2, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\defensive.ogg")
		else
			sndCZ:Schedule(7, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\aesoon.ogg") --準備AOE
		end
	end
end
...
function mod:SPELL_SUMMON(args)
	if args.spellId == 143641 then--Missile Launching
		...
		sndWOP:Play("Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\ex_so_fdzb.ogg") --飛彈準備
	end
...
function mod:SPELL_AURA_APPLIED(args)
	if args.spellId == 145365 then
		...
		if mod:IsTank() or mod:IsHealer() then
			sndWOP:Play("Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\speedup.ogg") --首領加速
		end
	...
	elseif args.spellId == 145269 then
		if self:AntiSpam(30, 3) then --BHFIX
			...
			sndDL:Play("Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\killmine.ogg") --地雷快打
			DLneedshow = true
		end
...
--[[	elseif args.spellId == 143867 then
	...
	elseif args.spellId == 144466 and self:AntiSpam(15, 1) then--Only way i see to detect magnet activation, antispam is so it doesn't break if a player dies during it.
		...
		sndWOP:Play("Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\ex_so_dczd.ogg") --電磁震蕩
...
function mod:UNIT_DIED(args)
	...
	if cid == 71591 then
		...
		sndCZ:Cancel("Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\aesoon.ogg")
		sndCZ4:Cancel("Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\ex_so_bh_4cz.ogg")
		sndCZ4:Cancel("Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\defensive.ogg")
		sndCZ5:Cancel("Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\ex_so_bh_5cz.ogg")
		sndCZ5:Cancel("Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\defensive.ogg")
	end
end
...
--			yellCrawlerMineFixate:Yell()
			sndWOP:Play("Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\ex_so_dlsd.ogg") --地雷鎖定
		end
...
function mod:CHAT_MSG_RAID_BOSS_EMOTE(msg, npc, _, _, target)
	if msg == L.newWeapons or msg:find(L.newWeapons) then
		...
		if weapon == 1 and (not mod.Options.SoundCS2) then
			sndWOP:Schedule(30, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\ex_so_tenwq.ogg") --10秒後武器啟動
		end
		
		if weapon % 2 == 1 then
			sndCS2:Schedule(30, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\ex_so_bh_2zu.ogg") --2組
			sndCS2:Schedule(31, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\ex_so_bh_2zu.ogg")
		end
		
		if weapon % 2 == 0 then
			sndCS1:Schedule(30, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\ex_so_bh_1zu.ogg") --1組
			sndCS1:Schedule(31, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\ex_so_bh_1zu.ogg")
		end
		
		if MyCS() or (mod.Options.optCS == "CSALL") then
			sndWOP:Play("Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\ex_so_kqcs.ogg") --快去傳送帶
			...
			if mod.Options[weaponoption] == "killdl" then
				sndWOP:Schedule(2, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\ex_so_dddl.ogg") --打掉地雷
				sndWOP:Schedule(3, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\ex_so_dddl.ogg")
			...
			elseif mod.Options[weaponoption] == "killfd" then
				sndWOP:Schedule(2, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\ex_so_ddfd.ogg") --打掉飛彈
				sndWOP:Schedule(3, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\ex_so_ddfd.ogg")
				if mod.Options.ShowDps then
					self:Schedule(40, function()
						table.wipe(Damagesort)
			...
			elseif mod.Options[weaponoption] == "killjg" then
				sndWOP:Schedule(2, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\ex_so_ddjg.ogg") --打掉激光
				sndWOP:Schedule(3, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\ex_so_ddjg.ogg")
				if mod.Options.ShowDps then
					self:Schedule(40, function()
						table.wipe(Damagesort)
			...
			elseif mod.Options[weaponoption] == "killdc" then
				sndWOP:Schedule(2, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\ex_so_dddc.ogg") --打掉電磁鐵
				sndWOP:Schedule(3, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\ex_so_dddc.ogg")
				if mod.Options.ShowDps then
					self:Schedule(40, function()
						table.wipe(Damagesort)
	...
	elseif msg == L.newShredder or msg:find(L.newShredder) then
		...
		if mod:IsTank() or mod:IsHealer() then
			sndWOP:Play("Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\ex_so_fmjc.ogg") --伐木機出現
		end
	end
end
...
function mod:OnSync(msg, guid)
	if msg == "LaserTarget" and guid then		
		...
		if guid ~= UnitGUID("player") then
			...
			sndWOP:Play("Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\ex_so_xxhx.ogg") --小心火線
		end
	end
end
