...
function mod:DeathFromAboveTarget(sGUID)
	...
	if targetname == UnitName("player") then
		...
		sndWOP:Play("Interface\\AddOns\\VEM-Core\\extrasounds\\"..VEM.Options.CountdownVoice.."\\ex_so_sctj.mp3") --死從
	else
		...
		if uId then
			...
			if inRange and inRange < 20 then
				...
				sndWOP:Play("Interface\\AddOns\\VEM-Core\\extrasounds\\"..VEM.Options.CountdownVoice.."\\ex_so_sctj.mp3")
			end
		end
	end
end
...
function mod:SPELL_CAST_START(args)
	...
	elseif args.spellId == 144208 then
		...
		sndFMD:Schedule(3, "Interface\\AddOns\\VEM-Core\\extrasounds\\"..VEM.Options.CountdownVoice.."\\ex_so_fmjd.mp3") --伐木機快打
	end
end
...
--		timerShockwaveMissileActive:Start()
	...
	elseif args.spellId == 145774 then
		...
		if cid == 71638 then
			sndWOP:Play("Interface\\AddOns\\VEM-Core\\extrasounds\\"..VEM.Options.CountdownVoice.."\\ex_so_fdqh.mp3") --飛彈強化
		elseif cid == 71752 then
			sndWOP:Play("Interface\\AddOns\\VEM-Core\\extrasounds\\"..VEM.Options.CountdownVoice.."\\ex_so_jgqh.mp3") --激光強化
		elseif cid == 71696 then
			sndWOP:Play("Interface\\AddOns\\VEM-Core\\extrasounds\\"..VEM.Options.CountdownVoice.."\\ex_so_ccqh.mp3") --磁場強化
		else
			sndWOP:Play("Interface\\AddOns\\VEM-Core\\extrasounds\\"..VEM.Options.CountdownVoice.."\\ex_so_dlqh.mp3") --地雷強化
		end
	elseif args.spellId == 145444 then
		...
		if OverloadCount == 3 then
			sndCZ4:Schedule(6, "Interface\\AddOns\\VEM-Core\\extrasounds\\"..VEM.Options.CountdownVoice.."\\ex_so_bh_4cz.mp3") --超載4
			sndCZ4:Schedule(7.5, "Interface\\AddOns\\VEM-Core\\extrasounds\\"..VEM.Options.CountdownVoice.."\\defensive.mp3") --注意減傷
			sndCZ4:Schedule(8.2, "Interface\\AddOns\\VEM-Core\\extrasounds\\"..VEM.Options.CountdownVoice.."\\defensive.mp3")
		elseif OverloadCount == 4 then
			sndCZ5:Schedule(6, "Interface\\AddOns\\VEM-Core\\extrasounds\\"..VEM.Options.CountdownVoice.."\\ex_so_bh_5cz.mp3") --超載5
			sndCZ5:Schedule(7.5, "Interface\\AddOns\\VEM-Core\\extrasounds\\"..VEM.Options.CountdownVoice.."\\defensive.mp3")
			sndCZ5:Schedule(8.2, "Interface\\AddOns\\VEM-Core\\extrasounds\\"..VEM.Options.CountdownVoice.."\\defensive.mp3")
		else
			sndCZ:Schedule(7, "Interface\\AddOns\\VEM-Core\\extrasounds\\"..VEM.Options.CountdownVoice.."\\aesoon.mp3") --準備AOE
		end
	end
end
...
function mod:SPELL_SUMMON(args)
	if args.spellId == 143641 then--Missile Launching
		...
		sndWOP:Play("Interface\\AddOns\\VEM-Core\\extrasounds\\"..VEM.Options.CountdownVoice.."\\ex_so_fdzb.mp3") --飛彈準備
	end
...
function mod:SPELL_AURA_APPLIED(args)
	...
	elseif args.spellId == 145269 then
		if self:AntiSpam(30, 3) then --BHFIX
			...
			sndDL:Play("Interface\\AddOns\\VEM-Core\\extrasounds\\"..VEM.Options.CountdownVoice.."\\killmine.mp3") --地雷快打
			DLneedshow = true
		end
...
--[[	elseif args.spellId == 143867 then
	...
	elseif args.spellId == 144466 and self:AntiSpam(15, 1) then--Only way i see to detect magnet activation, antispam is so it doesn't break if a player dies during it.
		...
		sndWOP:Play("Interface\\AddOns\\VEM-Core\\extrasounds\\"..VEM.Options.CountdownVoice.."\\ex_so_dczd.mp3") --電磁震蕩
...
function mod:UNIT_DIED(args)
	...
	if cid == 71591 then
		...
		sndCZ:Cancel("Interface\\AddOns\\VEM-Core\\extrasounds\\"..VEM.Options.CountdownVoice.."\\aesoon.mp3")
		sndCZ4:Cancel("Interface\\AddOns\\VEM-Core\\extrasounds\\"..VEM.Options.CountdownVoice.."\\ex_so_bh_4cz.mp3")
		sndCZ4:Cancel("Interface\\AddOns\\VEM-Core\\extrasounds\\"..VEM.Options.CountdownVoice.."\\defensive.mp3")
		sndCZ5:Cancel("Interface\\AddOns\\VEM-Core\\extrasounds\\"..VEM.Options.CountdownVoice.."\\ex_so_bh_5cz.mp3")
		sndCZ5:Cancel("Interface\\AddOns\\VEM-Core\\extrasounds\\"..VEM.Options.CountdownVoice.."\\defensive.mp3")
	end
end
...
--			yellCrawlerMineFixate:Yell()
			sndWOP:Play("Interface\\AddOns\\VEM-Core\\extrasounds\\"..VEM.Options.CountdownVoice.."\\ex_so_dlsd.mp3") --地雷鎖定
		end
	elseif msg:find("Ability_Siege_Engineer_Superheated") then
		if self:AntiSpam(3, 10) then
			...
			VEM.Flash:Shake(1, 0, 0)
			yellLaserFixate:Yell()
			sndWOP:Play("Interface\\AddOns\\VEM-Core\\extrasounds\\"..VEM.Options.CountdownVoice.."\\laserrun.mp3") --快跑,激光點你
			if mod.Options.LTFD then
...
function mod:CHAT_MSG_RAID_BOSS_EMOTE(msg, npc, _, _, target)
	if msg == L.newWeapons or msg:find(L.newWeapons) then
		...
		if weapon == 1 and (not mod.Options.SoundCS2) then
			sndWOP:Schedule(30, "Interface\\AddOns\\VEM-Core\\extrasounds\\"..VEM.Options.CountdownVoice.."\\ex_so_tenwq.mp3") --10秒後武器啟動
		end
		
		if weapon % 2 == 1 then
			sndCS2:Schedule(30, "Interface\\AddOns\\VEM-Core\\extrasounds\\"..VEM.Options.CountdownVoice.."\\ex_so_bh_2zu.mp3") --2組
			sndCS2:Schedule(31, "Interface\\AddOns\\VEM-Core\\extrasounds\\"..VEM.Options.CountdownVoice.."\\ex_so_bh_2zu.mp3")
		end
		
		if weapon % 2 == 0 then
			sndCS1:Schedule(30, "Interface\\AddOns\\VEM-Core\\extrasounds\\"..VEM.Options.CountdownVoice.."\\ex_so_bh_1zu.mp3") --1組
			sndCS1:Schedule(31, "Interface\\AddOns\\VEM-Core\\extrasounds\\"..VEM.Options.CountdownVoice.."\\ex_so_bh_1zu.mp3")
		end
	...
	elseif msg == L.newShredder or msg:find(L.newShredder) then
		...
		if mod:IsTank() or mod:IsHealer() then
			sndWOP:Play("Interface\\AddOns\\VEM-Core\\extrasounds\\"..VEM.Options.CountdownVoice.."\\ex_so_fmjc.mp3") --伐木機出現
		end
	end
end
...
function mod:OnSync(msg, guid)
	if msg == "LaserTarget" and guid then		
		...
		if guid ~= UnitGUID("player") then
			...
			sndWOP:Play("Interface\\AddOns\\VEM-Core\\extrasounds\\"..VEM.Options.CountdownVoice.."\\ex_so_xxhx.mp3") --小心火線
		end
	end
end
