local mod	= VEM:NewMod(1228, "VEM-Party-WoD", 8, 559)
...
function mod:OnCombatStart(delay)
	VEM:AddMsg("Notice, this boss mod may have very unreliable combat detection until missing IEEU or ES event is fixed by blizzard")
