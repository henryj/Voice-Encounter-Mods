local mod	= VEM:NewMod(725, "VEM-Pandaria", nil, 322, 1) -- 322 = Pandaria/Outdoor I assume
...
function mod:RAID_BOSS_EMOTE(msg)
	if msg:find("spell:121600") then
		...
		if mod:IsTank() then
			sndWOP:Schedule(58, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\ex_mop_zbpj.mp3")
		end
	elseif msg:find("spell:121787") then
		warnStomp:Show()
		specWarnStomp:Show()
		sndWOP:Play("Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\stompsoon.mp3")
		warnWarmonger:Schedule(10)
		specWarnWarmonger:Schedule(10)
		sndWOP:Schedule(10, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\mobsoon.mp3") --準備小怪
		timerStomp:Start()
