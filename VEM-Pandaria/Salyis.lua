...
function mod:RAID_BOSS_EMOTE(msg)
	if msg:find("spell:121600") then
		...
		if mod:IsTank() then
			sndWOP:Schedule(58, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\ex_mop_zbpj.ogg")
		end
	elseif msg:find("spell:121787") then
		warnStomp:Show()
		specWarnStomp:Show()
		sndWOP:Play("Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\stompsoon.ogg")
		warnWarmonger:Schedule(10)
		specWarnWarmonger:Schedule(10)
		sndWOP:Schedule(10, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\mobsoon.ogg") --準備小怪
		timerStomp:Start()
