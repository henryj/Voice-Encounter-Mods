local mod	= VEM:NewMod(858, "VEM-Pandaria", nil, 322, 1)
...
function mod:SPELL_CAST_START(args)
	if args.spellId == 144530 then
		...
		if mod:IsTank() or mod:IsHealer() then
			sndWOP:Play("Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\breathsoon.ogg") --準備吐息
		end
	end
end
...
function mod:OnSync(msg)
	...
	elseif msg == "Wave" and self:IsInCombat() then
		...
		sndWOP:Play("Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\firewall.ogg") --火牆
	end
end
