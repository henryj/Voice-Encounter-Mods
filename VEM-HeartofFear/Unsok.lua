...
local function warnAmberExplosionCast(spellId)
	if #canInterrupt == 0 then--This will never happen if fired by "InterruptAvailable" sync since it should always be 1 or greater. This is just a fallback if contructs > 0 and we scheduled "warnAmberExplosionCast" there
		...
		if spellId == 122398 then
			sndWOP:Play("Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\ex_mop_hpbz.ogg") --琥珀爆炸
		end
...
function mod:SPELL_AURA_APPLIED(args)
	...
	elseif args:IsSpellID(121949) then
		...
		if mod:IsHealer() and (not playerIsConstruct) then
			sndWOP:Play("Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\ex_mop_jscz.ogg") --寄生成長
		end
	elseif args:IsSpellID(122540) then
		...
		sndWOP:Schedule(48.5, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\countseven.ogg")
		sndWOP:Schedule(49.5, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\countsix.ogg")
		sndWOP:Schedule(50.5, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\countfive.ogg")
		sndWOP:Schedule(51.5, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\countfour.ogg")
		sndWOP:Schedule(52.5, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\countthree.ogg")
		sndWOP:Schedule(53.5, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\counttwo.ogg")
		sndWOP:Schedule(54.5, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\countone.ogg")
	...
	elseif args:IsSpellID(122784) then
		...
		if args:IsPlayer() then
			...
			sndWOP:Play("Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\ex_mop_nbzh.ogg") --你被轉化
	...
	elseif args:IsSpellID(125502) then
		...
		if args:IsPlayer() then
			...
			sndWOP:Play("Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\orbrun.ogg") --寶珠快跑
		end
	end
end
...
function mod:SPELL_AURA_REMOVED(args)
	...
	elseif args:IsSpellID(122540) then--Phase 3
		...
		sndWOP:Cancel("Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\countseven.ogg")
		sndWOP:Cancel("Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\countsix.ogg")
...
function mod:SPELL_CAST_START(args)
	...
	elseif args:IsSpellID(122402) then--Amber Monstrosity
		...
		warnAmberExplosion:Show(args.sourceName, args.spellName)
		sndWOP:Play("Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\ex_mop_jgbz.ogg") --巨怪爆炸
		warnAmberExplosionSoon:Cancel()
		warnAmberExplosionSoon:Schedule(41)
		timerAmberExplosion:Start()
		timerAmberExplosionAMCD:Start(46, args.spellName)
		sndWOP:Schedule(39, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\countseven.ogg")
		sndWOP:Schedule(40, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\countsix.ogg")
		sndWOP:Schedule(41, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\countfive.ogg")
		sndWOP:Schedule(42, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\countfour.ogg")
		sndWOP:Schedule(43, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\countthree.ogg")
		sndWOP:Schedule(44, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\counttwo.ogg")
		sndWOP:Schedule(45, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\countone.ogg")
		self:Unschedule(warnAmberExplosionCast)
	...
	elseif args:IsSpellID(122408) then
		if not playerIsConstruct then
			...
			sndWOP:Play("Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\stompsoon.ogg") --準備踐踏
		end
...
function mod:UNIT_POWER(uId)
	...
	elseif playerWill < 18 and not warnedWill then--5 seconds before 0 (after subtracking a budget of 8 for interrupt)
		...
		sndWOP:Play("Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\ex_mop_yzgd.ogg") --意志過低
...
function mod:SWING_DAMAGE(sourceGUID, _, _, _, destGUID)
	...
	if cid == 62691 and destGUID == UnitGUID("player") and not warnedoo[sourceGUID] and not playerIsConstruct then
		sndADD:Play("Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\didi.ogg")
		specwarnOOYou:Show()
