...
function mod:SPELL_AURA_APPLIED(args)
	if args:IsSpellID(122224, 61721) and args.sourceName == UnitName("player") then
		...
		sndDS:Cancel("Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\ex_mop_kzjs.ogg")
		sndDS:Cancel("Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\countten.ogg")
		sndDS:Cancel("Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\countnine.ogg")
		sndDS:Cancel("Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\counteight.ogg")	
		sndDS:Cancel("Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\countseven.ogg")
		sndDS:Cancel("Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\countsix.ogg")
		sndDS:Cancel("Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\countfive.ogg")	
		sndDS:Cancel("Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\countfour.ogg")	
		sndDS:Cancel("Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\countthree.ogg")
		sndDS:Cancel("Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\counttwo.ogg")
		sndDS:Cancel("Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\countone.ogg")
		sndDS:Cancel("Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\ex_mop_kzjs.ogg")
		sndDS:Schedule(30, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\ex_mop_kzjs.ogg") --控制即將結束	
		sndDS:Schedule(40, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\countten.ogg")
		sndDS:Schedule(41, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\countnine.ogg")
		sndDS:Schedule(42, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\counteight.ogg")	
		sndDS:Schedule(43, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\countseven.ogg")
		sndDS:Schedule(44, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\countsix.ogg")
		sndDS:Schedule(45, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\countfive.ogg")	
		sndDS:Schedule(46, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\countfour.ogg")	
		sndDS:Schedule(47, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\countthree.ogg")
		sndDS:Schedule(48, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\counttwo.ogg")
		sndDS:Schedule(49, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\countone.ogg")	
					...
					if not UnitDebuff("player", GetSpellInfo(122055)) then
						if self:AntiSpam(2, 7) then
							if math.random(1, 2) == 1 then
								sndJR:Play("Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\helpme.ogg") --救我
							else
								sndJR:Play("Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\helpme2.ogg")
							end
						end
					end
				end
	...
	elseif args:IsSpellID(125873) then
		...
		sndWOP:Play("Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\ex_mop_lumang.ogg") --魯莽
	...
	if args:IsSpellID(122406) then
		...
		if mod:IsHealer() then
			if not ptwo then
				...
				sndWOP:Schedule(58, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\countthree.ogg")
				sndWOP:Schedule(59, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\counttwo.ogg")
				sndWOP:Schedule(60, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\countone.ogg")
			else
				sndWOP:Cancel("Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\countthree.ogg")
				sndWOP:Cancel("Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\counttwo.ogg")
				sndWOP:Cancel("Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\countone.ogg")
				sndWOP:Play("Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\healall.ogg") --注意群療
				sndWOP:Schedule(45, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\countthree.ogg")
				sndWOP:Schedule(46, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\counttwo.ogg")
				sndWOP:Schedule(47, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\countone.ogg")
			end
		else
...
function mod:RAID_BOSS_EMOTE(msg)
	if msg == L.Reinforcements or msg:find(L.Reinforcements) then
		...
		sndWOP:Play("Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\ex_mop_xcqcx.ogg") --新蟲群出現
	end
end
...
function mod:UNIT_SPELLCAST_SUCCEEDED(uId, _, _, _, spellId)
	if spellId == 124850 and self:AntiSpam(2, 1) then--Whirling Blade (Throw Cast spellid)
		...
		sndWOP:Play("Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\ex_mop_fd.ogg") --飛刀
	...
	elseif spellId == 131813 and self:AntiSpam(2, 3) then
		if not ptwo then
			...
			if mod:IsHealer() then
				...
				sndWOP:Cancel("Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\counttwo.ogg")
				sndWOP:Cancel("Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\countone.ogg")
				sndWOP:Schedule(17, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\countthree.ogg")
				sndWOP:Schedule(18, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\counttwo.ogg")
				sndWOP:Schedule(19, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\countone.ogg")
			end
		end
		ptwo = true
	end
...
function mod:UNIT_AURA_UNFILTERED(uId)
	...
	if UnitDebuff("player", strikeTarget) and not strikeWarned then--Warn you that you have a meteor
		sndWOP:Play("Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\holdit.ogg")--自保技能
	...
	if msg == "KorthikStrikeTarget" and guids[guid] then
		...
		if ((mod.Options.optBH == "BH1") and (cfcount % 4 == 1)) or ((mod.Options.optBH == "BH2") and (cfcount % 4 == 2)) or ((mod.Options.optBH == "BH3") and (cfcount % 4 == 3)) or ((mod.Options.optBH == "BH4") and (cfcount % 4 == 0)) then
			if guid ~= UnitGUID("player") then--make sure YOU aren't target before warning "other"
				...
				sndWOP:Play("Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\ex_mop_kgbh.ogg") --快給保護
			end
