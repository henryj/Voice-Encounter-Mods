...
function mod:SPELL_AURA_APPLIED(args)
	if args:IsSpellID(122224, 61721) and args.sourceName == UnitName("player") then
		...
		sndDS:Cancel("Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\ex_mop_kzjs.mp3")
		sndDS:Cancel("Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\countten.mp3")
		sndDS:Cancel("Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\countnine.mp3")
		sndDS:Cancel("Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\counteight.mp3")	
		sndDS:Cancel("Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\countseven.mp3")
		sndDS:Cancel("Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\countsix.mp3")
		sndDS:Cancel("Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\countfive.mp3")	
		sndDS:Cancel("Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\countfour.mp3")	
		sndDS:Cancel("Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\countthree.mp3")
		sndDS:Cancel("Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\counttwo.mp3")
		sndDS:Cancel("Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\countone.mp3")
		sndDS:Cancel("Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\ex_mop_kzjs.mp3")
		sndDS:Schedule(30, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\ex_mop_kzjs.mp3") --控制即將結束	
		sndDS:Schedule(40, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\countten.mp3")
		sndDS:Schedule(41, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\countnine.mp3")
		sndDS:Schedule(42, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\counteight.mp3")	
		sndDS:Schedule(43, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\countseven.mp3")
		sndDS:Schedule(44, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\countsix.mp3")
		sndDS:Schedule(45, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\countfive.mp3")	
		sndDS:Schedule(46, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\countfour.mp3")	
		sndDS:Schedule(47, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\countthree.mp3")
		sndDS:Schedule(48, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\counttwo.mp3")
		sndDS:Schedule(49, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\countone.mp3")	
					...
					if not UnitDebuff("player", GetSpellInfo(122055)) then
						if self:AntiSpam(2, 7) then
							if math.random(1, 2) == 1 then
								sndJR:Play("Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\helpme.mp3") --救我
							else
								sndJR:Play("Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\helpme2.mp3")
							end
						end
					end
				end
	...
	elseif args:IsSpellID(125873) then
		...
		sndWOP:Play("Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\ex_mop_lumang.mp3") --魯莽
	...
	if args:IsSpellID(122406) then
		...
		if mod:IsHealer() then
			if not ptwo then
				...
				sndWOP:Schedule(58, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\countthree.mp3")
				sndWOP:Schedule(59, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\counttwo.mp3")
				sndWOP:Schedule(60, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\countone.mp3")
			else
				sndWOP:Cancel("Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\countthree.mp3")
				sndWOP:Cancel("Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\counttwo.mp3")
				sndWOP:Cancel("Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\countone.mp3")
				sndWOP:Play("Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\healall.mp3") --注意群療
				sndWOP:Schedule(45, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\countthree.mp3")
				sndWOP:Schedule(46, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\counttwo.mp3")
				sndWOP:Schedule(47, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\countone.mp3")
			end
		else
...
function mod:RAID_BOSS_EMOTE(msg)
	if msg == L.Reinforcements or msg:find(L.Reinforcements) then
		...
		sndWOP:Play("Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\ex_mop_xcqcx.mp3") --新蟲群出現
	end
end
...
function mod:UNIT_SPELLCAST_SUCCEEDED(uId, _, _, _, spellId)
	if spellId == 124850 and self:AntiSpam(2, 1) then--Whirling Blade (Throw Cast spellid)
		...
		sndWOP:Play("Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\ex_mop_fd.mp3") --飛刀
	...
	elseif spellId == 131813 and self:AntiSpam(2, 3) then
		if not ptwo then
			...
			if mod:IsHealer() then
				...
				sndWOP:Cancel("Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\counttwo.mp3")
				sndWOP:Cancel("Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\countone.mp3")
				sndWOP:Schedule(17, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\countthree.mp3")
				sndWOP:Schedule(18, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\counttwo.mp3")
				sndWOP:Schedule(19, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\countone.mp3")
			end
		end
		ptwo = true
	end
...
function mod:UNIT_AURA_UNFILTERED(uId)
	...
	if UnitDebuff("player", strikeTarget) and not strikeWarned then--Warn you that you have a meteor
		sndWOP:Play("Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\holdit.mp3")--自保技能
	...
	if msg == "KorthikStrikeTarget" and guids[guid] then
		...
		if ((mod.Options.optBH == "BH1") and (cfcount % 4 == 1)) or ((mod.Options.optBH == "BH2") and (cfcount % 4 == 2)) or ((mod.Options.optBH == "BH3") and (cfcount % 4 == 3)) or ((mod.Options.optBH == "BH4") and (cfcount % 4 == 0)) then
			if guid ~= UnitGUID("player") then--make sure YOU aren't target before warning "other"
				...
				sndWOP:Play("Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\ex_mop_kgbh.mp3") --快給保護
			end
