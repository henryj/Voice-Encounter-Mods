...
function mod:SPELL_AURA_APPLIED(args)
	...
	elseif args.spellId == 107087 then
		...
		if args:IsPlayer() then
			...
			sndWOP:Play("Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\ex_mop_zhgg.mp3")--憎恨過高
		end
...
function mod:SPELL_CAST_START(args)
	if args.spellId == 115002 and self:AntiSpam(5, 2) then
		...
		sndWOP:Play("Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\ex_mop_zqkd.mp3")--紫球快打
	end
end
