...
function mod:SPELL_AURA_REMOVED(args)
	if args.spellId == 119476 and VEM.BossHealth:IsShown() then--When bullwark breaks, he will instantly cast either tempest or blade rush, need more logs to determine if it's random or set.
		hideShieldHealthBar()
	end
end
