...
function mod:OnCombatStart(delay)
	...
	sndWOP:Schedule(15, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\telesoon.mp3")--準備傳送
...
function mod:CHAT_MSG_RAID_BOSS_EMOTE(msg, _, _, _, target)--Just until there is a better way
	if msg:find("spell:113395") then
		...
		timerLessonCD:Start()
		sndWOP:Schedule(28, "Interface\\AddOns\\"..VEM.Options.CountdownVoice.."\\telesoon.mp3")--準備傳送
	end
end